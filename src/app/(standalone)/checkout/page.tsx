            ...
            <Card className="bg-[#1a1a1a] border-gray-800">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-4">
                  <div className="relative w-40 h-20 bg-[#2a2a2a] rounded-lg overflow-hidden">
                    <Image
                    ...
                    />
                    <div className="absolute top-0 right-0 bg-[#f3942c] text-black text-xs rounded-full w-6 h-6 flex items-center justify-center font-bold">
                      {quantity}
                    </div>
                  </div>
